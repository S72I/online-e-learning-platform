            ...
            <Grid container spacing={2} sx={{ mt: 12, px: { md: 4, xs: 2, lg: 6, xl: 6 } }}>
                <Container sx={{
                    ...
                    <Box sx={{ height: 200, width: "30%" }}>
                        <Typography sx={{ px: 4, fontSize: 30, fontFamily: 'revert', fontWeight: '700', wordBreak: 'break-word' }}>Frequently <br /> Asked Questions</Typography>
                        <Typography sx={{
                            px: 4,
                            mt: 2,
                            fontSize: 15,
                            color: '#59595A',
                        }}>Still you have any questions? Contact our Team via support@skillbridge.com</Typography>
                        <Button sx={{
                            mx: 4,
                    ...
                    <Box sx={{ overflow: 'scroll', height: "auto", width: "65%" }}>
                        {QnA.map((data, index) => (
                            <Accordion key={index} sx={{ m: 2, boxShadow: 'none', border: '0.5px solid', borderColor: '#F2F0EF' }}>

                                <AccordionSummary
                                    sx={{ px: 4 }}
                                    expandIcon={<AddIcon sx={{
                                        borderRadius: 2,
                                        bgcolor: '#FFF4E5',
                                        p: 0.8,
                                        fontSize: 30,
                                ...
                                <Box sx={{ my: 4, px: 4, alignItems: 'center', display: 'flex', justifyContent: 'space-between', justifySelf: 'center', width: "80%", height: 50, bgcolor: '#F1F1F3' }}>
